...
public class CatalogActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        petListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                // Create the new intent to go to EditorActivity
                Intent intent = new Intent(CatalogActivity.this, EditorActivity.class);

                // Append the ID that represents the specific pet that was clicked on after the
                // content URI
                ...
                // Launch EditorActivity to display data from the current pet
                startActivity(intent);
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        // Defines a projection that specifies the columns from the table
        String[] projection = {
                PetEntry._ID,
